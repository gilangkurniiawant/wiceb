...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <label for="">Jumlah Voc Kosong : <?= $jum ?></label>
            <br>
            <div class="col-md-offset-2 col-md-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="voc_act.php">
                            <div class="form-group">
                                <label class="col-md-2 control-label">Kode Generate</label>
                                <div class="col-md-10">
                                    <textarea name="nama" class="form-control" rows="8%"></textarea>
                                </div>
                            </div>
